...
import { AddCompetitionSkillHandler } from './add-competition-skill.handler';

describe('AddCompetitionSkillHandler', () => {
  let handler: AddCompetitionSkillHandler;
  ...
  beforeEach(() => {
    ...
    handler = new AddCompetitionSkillHandler(mockEventBus, mockEventStore as EventStoreDBClient);
  });

  it('should handle AddCompetitionSkillCommand correctly', async () => {
    ...
    // Mock for AddCompetitionSkillInput
    ...
    const command = new AddCompetitionSkillCommand(mockAddCompetitionSkillInput, mockMetadata);
    ...
    expect(mockEventBus.publishAll).toHaveBeenCalledWith([
      {
        type: 'CompetitionSkillAddedEvent',
        data: {
          competition_id: 'd290f1ee-6c54-4b01-90e6-d701748f0851',
          skill_id: 'd290f1ee-6c54-4b01-90e6-d701748f0852',
          min_years_experience: 2,
