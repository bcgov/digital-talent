...
import { CreateJobDescriptionHandler } from './create-job-description.handler';

describe('CreateJobDescriptionHandler', () => {
  let handler: CreateJobDescriptionHandler;
  ...
  beforeEach(() => {
    ...
    handler = new CreateJobDescriptionHandler(mockEventBus, mockEventStore as EventStoreDBClient);
  });

  it('should handle CreateJobDescriptionCommand correctly', async () => {
    ...
    // Mock for CreateJobDescriptionInput
    ...
    const command = new CreateJobDescriptionCommand(mockCreateJobDescriptionInput, mockMetadata);
