...
import { CreateOpportunityLocationHandler } from './create-opportunity-location.handler';

describe('CreateOpportunityLocationHandler', () => {
  let handler: CreateOpportunityLocationHandler;
  ...
  beforeEach(() => {
    ...
    handler = new CreateOpportunityLocationHandler(mockEventBus, mockEventStore as EventStoreDBClient);
  });

  it('should handle CreateOpportunityLocationCommand correctly', async () => {
    ...
    // Mock for CreateOpportunityLocationInput
    ...
    const command = new CreateOpportunityLocationCommand(mockCreateOpportunityLocationInput, mockMetadata);
    ...
    expect(mockEventBus.publishAll).toHaveBeenCalledWith([
      {
        type: 'OpportunityLocationCreatedEvent',
        data: {
          opportunity_id: 'd290f1ee-6c54-4b01-90e6-d701748f0851',
          location_id: 'd290f1ee-6c54-4b01-90e6-d701748f0852',
        },
