...
import { CreateElistHandler } from './create-elist.handler';

describe('CreateElistHandler', () => {
  let handler: CreateElistHandler;
  ...
  beforeEach(() => {
    ...
    handler = new CreateElistHandler(mockEventBus, mockEventStore as EventStoreDBClient);
  });

  it('should handle CreateElistCommand correctly', async () => {
    ...
    const command = new CreateElistCommand(mockCreateElistInput, mockMetadata);
