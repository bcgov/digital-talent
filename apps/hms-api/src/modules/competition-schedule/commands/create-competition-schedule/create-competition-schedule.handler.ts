...
@CommandHandler(CreateCompetitionScheduleCommand)
export class CreateCompetitionScheduleHandler implements ICommandHandler<CreateCompetitionScheduleCommand> {
  private readonly streamId = (command: CreateCompetitionScheduleCommand) => `competition-schedule-${command.data.id}`;

  private readonly handle: (command: CreateCompetitionScheduleCommand) => Promise<CommandHandlerResult>;
  ...
  async execute(command: CreateCompetitionScheduleCommand): Promise<any> {
