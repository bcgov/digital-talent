...
describe('UpdateApplicationHandler', () => {
  ...
  beforeEach(() => {
    ...
    handler = new UpdateApplicationHandler(mockEventBus, mockEventStore as EventStoreDBClient);
  });

  it('should handle UpdateApplicationCommand correctly', async () => {
    ...
    // Mock for UpdateApplicationInput
    const mockUpdateApplicationInput: UpdateApplicationInput = {
      id: 'd290f1ee-6c54-4b01-90e6-d701748f0851',
      json: { a: 'b' },
    };

    const command = new UpdateApplicationCommand(mockUpdateApplicationInput, mockMetadata);
