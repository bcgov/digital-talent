...
import { CreateApplicationSkillHandler } from './create-application-skill.handler';

describe('CreateApplicationSkillHandler', () => {
  let handler: CreateApplicationSkillHandler;
  ...
  beforeEach(() => {
    ...
    handler = new CreateApplicationSkillHandler(mockEventBus, mockEventStore as EventStoreDBClient);
  });

  it('should handle CreateApplicationSkillCommand correctly', async () => {
    ...
    // Mock for CreateApplicationSkillInput
    ...
    const command = new CreateApplicationSkillCommand(mockCreateApplicationSkillInput, mockMetadata);
    ...
    expect(mockEventBus.publishAll).toHaveBeenCalledWith([
      {
        type: 'ApplicationSkillCreatedEvent',
        data: {
          application_id: 'd290f1ee-6c54-4b01-90e6-d701748f0851', // example UUID
          skill_id: 'd290f1ee-6c54-4b01-90e6-d701748f0851', // example UUID
          years_experience: 5,
