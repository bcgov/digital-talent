...
describe('ApplicationSkillResolver', () => {
  ...
  beforeEach(() => {
    ...
    resolver = new ApplicationSkillResolver(mockCommandBus, mockQueryBus);
  });
  ...
  it('should get all application-skills correctly', async () => {
    ...
    mockQueryBus.execute.mockResolvedValueOnce(mockApplicationSkills);
  ...
  it('should get a specific application-skill by id correctly', async () => {
    ...
    mockQueryBus.execute.mockResolvedValueOnce(mockApplicationSkill);
