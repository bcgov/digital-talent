...
import { CreateGridCommand } from '../../modules/classification/commands/create-grid/create-grid.command';
import { DeleteGridCommand } from '../../modules/classification/commands/delete-grid/delete-grid.command';
import { UpdateGridCommand } from '../../modules/classification/commands/update-grid/update-grid.command';
...
export const gridSeeds: SeedType<GridSeed> = {
  upsert: [
    {
