...
import { SyncMinistryCommand } from '../modules/ministry/commands/sync-ministry/sync-ministry.command';
import { SyncMinistryInput } from '../modules/ministry/inputs/sync-ministry.input';

const syncSeeds: SyncMinistryInput[] = [
...
const syncCommands = syncSeeds.map((seed) => new SyncMinistryCommand(seed, { created_by: SYSTEM_USER_ID }));
